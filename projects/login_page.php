...
<body>
	...
	<div class="container text-center">
      ...
      <p>
      <a class="btn btn-primary social-login-btn social-linkedin" href="projects/social_login/linkedin/linkedin_login.php"><i class="fa fa-linkedin"></i></a>
      <a class="btn btn-primary social-login-btn social-google" href="projects/social_login/googlePlus/oauth2callback.php"><i class="fa fa-google-plus"></i></a>
      <a class="btn btn-primary social-login-btn social-facebook" href="projects/social_login/facebook/facebook_login.php"><i class="fa fa-facebook"></i></a>
      ...
      <div id="signInDiv" >
          ...
          <form id="loginForm" onSubmit="login(this)">
            ...
            id="inputEmail" placeholder="Email Address" type="text" autofocus><br>
            <input class=
            "ember-view ember-text-field form-control login-input-pass" id="inputPassword" placeholder="Password" type="password"> 
            ...
            data-bindattr-3="3" type="submit" onclick="$('#loginForm').submit()">Sign in</button><br>
          </form>
      ...
      <form class="form-signin" data-ember-action="2" style="padding-top:0px">
        <div id="signUpDiv" style="display:none;">
          ...
          <form id="signUpForm" >
            ...
            data-bindattr-3="3" type="submit" onClick="signup(this)">Sign Up</button><br>
